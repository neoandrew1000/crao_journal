...
<body class="site <?php echo $option . " view-" . $view . " layout-" . $layout . " task-" . $task . " itemid-" . $itemid . " ";?>">
	...
	<div class="container">
		<div id="content">
			...
			<div id="element-box" class="login well">
				<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template ?>/images/ghash.png" alt="Joomla!" />
				<hr />
	...
	<div class="navbar navbar-fixed-bottom hidden-phone">
		...
		<a class="login-joomla hasTooltip" href="http://www.joomla.org" target="_blank" title="<?php echo JHtml::tooltipText('TPL_GHASH_ISFREESOFTWARE'); ?>">Joomla!&#174;</a>
